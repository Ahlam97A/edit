...
import InputForm from './../Typography/InputForm';
const styles = {
  cardCategoryWhite: {
    "&,& a,& a:hover,& a:focus": {
...
class Notifications extends React.Component {
  ...
  render() {
    ...
    return (
      <center>
        <form onSubmit={this.handleSend} action="send.php">
                  ...
                  <div>
                    ...
                    <div style={{ display: 'flex', width: '100%' }}>
                      ...
                      <GridItem xs={12} sm={6} md={6} style={{ textAlign: "center" }}>
                        <InputLabel style={{ color: "#000", alignContent: "Center",fontFamily: "Comic Sans MS" }}> ID of Parent/Teacher :</InputLabel>
                      </GridItem>
                      {
                      this.state.data.map((item,i)=>(
                        <div key={i}>
                      <GridItem xs={12} sm={6} md={6}>
                        <input required  defaultValue={item.parent} style={styleInput1}
                         name="id" onChange={this.updateInput} max={this.props.max} />
                      </GridItem>
                      </div>
                      ))}
                    ...
                    <div style={{ display: 'flex', width: '100%' }}>
                      ...
                      <GridItem xs={12} sm={6} md={6}>
                        <textarea required style={styleInput} name="message" rows="5" cols="105" onChange={this.updateInput} max={this.props.max}></textarea>
                      </GridItem>
